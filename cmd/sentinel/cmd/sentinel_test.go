...
func TestUpdateCluster(t *testing.T) {
	tests := []struct {
			...
			cd: &cluster.ClusterData{
				Cluster: &cluster.Cluster{
					...
					Spec: &cluster.ClusterSpec{
						...
						PGParameters:           cluster.DBMSParameters{"param01": "value01", "param02": "value02"},
		...
		// #14 Changed clusterSpec parameters. RequestTimeout, MaxStandbys, UsePgrewind, DBMSParameters should bet updated in the DBSpecs.
		{
			cd: &cluster.ClusterData{
				Cluster: &cluster.Cluster{
					UID:        "cluster1",
