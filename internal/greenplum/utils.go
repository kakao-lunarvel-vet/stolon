...
func GetSystemData(ctx context.Context, replConnParams ConnParams) (*dbmgr.SystemData, error) {
...
func parseTimelinesHistory(contents string) ([]*dbmgr.TimelineHistory, error) {
